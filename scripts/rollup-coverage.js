 ...
 *
 * A local, three-separate-reports convenience only — the CI-hosted
 * report (`scripts/publish-coverage.js`) is a single Istanbul-merged
 * report instead, per `hosting-test-coverage.md` §3.
 */
