...
- [x] `cdk/data/OperatorsTable.ts` — `gsi1-availability` (sparse) + `gsi2-roster`. Stream added `7-data-warehousing.md` Leg 6 (2026-09-13), once §2.3's warehouse job was built.
...
- [x] §2.3's all-time-cost warehouse job — `operator_fleet_cost_to_date`, shipped `7-data-warehousing.md` Leg 6 (2026-09-13).
