  ...
  tables: [
    ...
    },
    {
      ...
      columns: [
        ...
        { name: "sla_deadline", type: "string", comment: null },
        { name: "scheduled_start", type: "string", comment: null },
        { name: "scheduled_end", type: "string", comment: null },
        ...
        { name: "created_at", type: "string", comment: null },
        { name: "updated_at", type: "string", comment: null },
